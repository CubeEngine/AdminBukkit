<?php
    return array(
        ...
        'stat_user.login'                           => '{0} times logged on.',
        'stat_user.register'                        => '{0} user(s) was regisered.',
        ...
        'stat_api.succeeded.server_info'            => '{0} times the serverinformations was requested.',
        ...
        'stat_api.succeeded.player_info'            => '{0} times playerinformations were requested.',
        ...
        'stat_api.succeeded.plugin_info'            => '{0} times the plugininformations were requested.',
        'stat_api.succeeded.plugin_available'       => '{0} times was proofed, if the plugins are available.',
        'stat_api.succeeded.world_info'             => '{0} times the worldinformations were requested.',
