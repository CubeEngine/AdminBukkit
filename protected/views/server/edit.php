<form action="<?php echo $this->createUrl('server/edit') ?>" method="POST" accept-charset="utf-8" data-ajax="false">
    ...
    <input type="submit" value="<?php echo Yii::t('server', 'Save the changes!') ?>" />
</form>