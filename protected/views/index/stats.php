...
<?php if (count($userStats)): ?>
    <li data-role="list-divider"><?php echo Yii::t('stats', 'User statistics') ?></li>
...
<?php if (count($apiSuccess)): ?>
    <li data-role="list-divider"><?php echo Yii::t('stats', 'API statistics') ?></li>
...
<?php if (count($dlStats)): ?>
    <li data-role="list-divider"><?php $lang->downloads ?></li>
